...
from tracker.config_utils import get_config

DEFAULT_BYTETRACK_CONFIG_PATH = "tracker/config/byte_track.yaml"
DEFAULT_OCSORT_CONFIG_PATH = "tracker/config/oc_sort.yaml"
DEFAULT_NORFAIR_CONFIG_PATH = "tracker/config/norfair_track.yaml"
DEFAULT_STRONGSORT_CONFIG_PATH = "tracker/config/strong_sort.yaml"
DEFAULT_SORT_CONFIG_PATH = "tracker/config/sort_track.yaml"
